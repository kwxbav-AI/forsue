...
import { StoreOpsStoreCheckboxGrid } from "@/components/operations/StoreOpsStoreCheckboxGrid";
...
export default function SupervisorsPage() {
  ...
  function toggleRegion(ids: string[], select: boolean) {
    setStoreIds((prev) => {
