  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="max-h-[calc(100vh-14rem)] overflow-auto rounded-lg border border-slate-200 bg-white shadow-sm">
          <table className="min-w-full text-sm">
            <thead className="sticky top-0 z-10 bg-slate-50 text-xs text-slate-600 shadow-[0_1px_0_0_#e2e8f0]">
              <tr>
